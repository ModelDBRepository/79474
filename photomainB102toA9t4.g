...
*/
    setfield Iin level1 +0.5
    setfield /output/plot_out leave_open 1 append 0 flush 0 filename "B102toA9t4inject0.5nA.dat"
    reset
    step {800/0.005}

    setfield Iin level1 +0.3
    setfield /output/plot_out leave_open 1 append 0 flush 0 filename "B102toA9t4inject0.3nA.dat"
    reset
    step {800/0.005}
