...
6: Faster light current, but slightly less sensitive
...
echo "gkcsoma=" {gkca} {getfield soma/Cacyts1[10]/kc Gbar} "gkcaxon=" {gkcAfastaxon}
    ...
    setfield /output/plot_out leave_open 1 append 0 flush 0 filename "B102toA19inject0.1nA.dat"
    reset
    step {800/0.005}

    setfield Iin level1 -0.5
    setfield /output/plot_out leave_open 1 append 0 flush 0 filename "B102toA19inject-0.5nA.dat"
    reset
    step {800/0.005}

    setfield Iin level1 +0.5
    setfield /output/plot_out leave_open 1 append 0 flush 0 filename "B102toA19inject0.5nA.dat"
    reset
    step {800/0.005}

    setfield Iin level1 +0.3
    setfield /output/plot_out leave_open 1 append 0 flush 0 filename "B102toA19inject0.3nA.dat"
    reset
    step {800/0.005}
...
for (dur=30; dur<=3000; dur=dur*10)
  ...
  str filenam = (filepath)@"B102toA19cell-lgt"@(dur)@"-nd0.dat"
  setfield /output/plot_out filename {filenam} initialize 1 append 0 leave_open 1
  str filenam = (filepath)@"B102toA19cell-lgt"@(dur)@"-nd0.cal"
...
for (dur=30; dur<=3000; dur=dur*10)
  ...
  filenam = (filepath)@"B102toA19cell-lgt"@(dur)@"-nd1.dat"
  setfield /output/plot_out filename {filenam} initialize 1 append 0 leave_open 1
  filenam = (filepath)@"B102toA19cell-lgt"@(dur)@"-nd1.cal"
  setfield /output/cal filename {filenam} initialize 1 append 0 leave_open 1
...
for (dur=30; dur<=3000; dur=dur*10)
  ...
  filenam = (filepath)@"B102toA19cell-lgt"@(dur)@"-nd2.dat"
  setfield /output/plot_out filename {filenam} initialize 1 append 0 leave_open 1
  filenam = (filepath)@"B102toA19cell-lgt"@(dur)@"-nd2.cal"
  setfield /output/cal filename {filenam} initialize 1 append 0 leave_open 1
